...
###5. Build Linux .Net 10 Bot called WildLifeBildBot###
  ...
  - WildLifeBildBot you have to obtion
    - Create a Service on your OS your choice
    - or start dotnet run in your project path, if you want logout put the Bot in the Background and leave your shell
