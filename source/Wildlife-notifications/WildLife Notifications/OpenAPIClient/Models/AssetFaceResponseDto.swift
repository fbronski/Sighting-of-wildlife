...
public struct AssetFaceResponseDto: Sendable, Codable, ParameterConvertible, Hashable {
    ...
    public var person: PersonResponseDto?
    public var sourceType: SourceType?

    public init(boundingBoxX1: Int, boundingBoxX2: Int, boundingBoxY1: Int, boundingBoxY2: Int, id: UUID, imageHeight: Int, imageWidth: Int, person: PersonResponseDto?, sourceType: SourceType? = nil) {
...
extension AssetFaceResponseDto: Identifiable {}
