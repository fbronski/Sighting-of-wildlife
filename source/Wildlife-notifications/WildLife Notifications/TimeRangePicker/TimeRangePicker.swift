...
public struct TimeRangePicker: View {
    ...
    ///
    public init(_ value: Binding<Range<TimeInterval>>, in range: Range<TimeInterval> = 3600..<81800, isPresenting: Binding<Bool>, isCanceled: Binding<Bool>) {
    ...
    public var body: some View {
        NavigationStack {
            ...
            ZStack {
                ...
                .padding(28)
                .navigationTitle("Wähle den Zeitbereich")
