...
public struct Wildsichtung: Identifiable {
    ...
    init(id: Int64, title: String, subtitle: String, body: String, immichid: String, yolostatus: String, imagebase64: String, creationDate: Date, pinned: Bool = false) {
        self.id = id
        self.title = title
