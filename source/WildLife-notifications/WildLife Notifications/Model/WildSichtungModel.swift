...
/*public struct WildsichtungCamera: Equatable, Identifiable  {
...
public struct Wildsichtung: Equatable, Identifiable  {
    ...
    let body: String
    let immichid: String
    let yolostatus: String
    var imagebase64: String
    let creationDate: Date
    var pinned: Bool
    
    init(id: Int64,title: String,cameraid: String, subtitle: String, body: String, immichid: String, yolostatus: String, imagebase64: String, creationDate: Date, pinned: Bool = false) {
        self.id = id
        self.title = title
    ...
    /*static func data() -> [Wildsichtung] {
        
        return /*[
            
            Wildsichtung(name: "Aprilia",
            ...
            Wildsichtung(name: "Royal Enfield",
